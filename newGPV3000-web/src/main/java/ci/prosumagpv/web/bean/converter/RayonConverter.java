...
@FacesConverter(value = "rayonConverter")
public class RayonConverter implements Converter {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		try {
			...
			if(arg2 != null && arg2.equals("XXX")){
				...
				return new FactoryBean().getClassificationService().getRayon(arg2);
